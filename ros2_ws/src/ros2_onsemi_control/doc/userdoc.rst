...
1. To check that *DiffBot* description is working properly use following launch commands
   ...
   .. code-block:: shell
    ...
    ros2 launch ros2_onsemi_control view_robot.launch.py
...
5. If everything is fine, now you can send a command to *Diff Drive Controller* using ROS 2 CLI interface:
   ...
   .. code-block:: shell
    ...
    [ControlOnsemiHardware]: Got command 43.33333 for 'left_wheel_joint'!
    [ControlOnsemiHardware]: Got command 50.00000 for 'right_wheel_joint'!
...
6. Let's introspect the ros2_control hardware component. Calling
  ...
  .. code-block:: shell
    ...
    Hardware Component 1
            name: DiffBot
            type: system
            plugin name: ros2_onsemi_control/ControlOnsemiHardware

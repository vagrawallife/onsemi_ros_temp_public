...
def generate_launch_description():
    ...
    fws_robot_description_path = os.path.join(
        get_package_share_directory('onsemi_amr'))
    ...
    arguments = LaunchDescription([
                DeclareLaunchArgument('world', default_value='sim_robot_world',
    ...
    rviz_config_file = os.path.join(fws_robot_description_path, 'config', 'amr_onsemi.rviz')
